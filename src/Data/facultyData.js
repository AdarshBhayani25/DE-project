const facultyMembers = [
  // Computer Engineering
  {
    ...
    bio: "Proff. Kajal S. Patel hold a Ph.D. in Computer Information Technology Engineering from Gujarat Technological University (2018),an M.E. in Computer Science & Engineering from L.D. College of Engineering, Ahmedabad (Gujarat Technological University, 2011), and a B.E. in Computer Engineering from SVNIT, Surat (South Gujarat University, 2000). With extensive teaching experience, I have served as a Lecturer at Navagujarat College of Computer Applications for 4 years, an Assistant Professor at L.D. College of Engineering for 8 years, and as an Associate Professor and HOD of the Computer Department at Government Engineering College, Rajkot for 5 years, where I was also a member of the procurement committee in TEQIP and the TEQIP MIS nodal officer. Currently, I am an Associate Professor at Vishwakarma Government Engineering College, Chandkheda. My skills include proficiency in operating systems like DOS, Windows 7, and Linux, programming languages such as C, C++, VB, Java, Android, JSP, and servlet, as well as database systems like Oracle and MySQL, and web technologies including HTML, WML, WMLScript, Android, and PHP, with a solid background in application development and networking.",
    block: "D",
  ...
  },
  {
    ...
    bio: "Proff. Jalpa M. Ramavat is an Assistant Professor with 14 years of experience in education and computer science. She holds a B.E. in Computer Engineering from Atmiya Institute of Technology & Science, graduating with First Class with Distinction in 2004, and an M.Tech in Computer Engineering from Gujarat Technological University, completed in 2015. Her areas of interest include Mobile Computing and Cloud Computing. She has worked as a Lecturer at Kamani Science College, Amreli (2004-2008), in the industry with Bharat Sanchar Nigam Ltd (2008-2011), and as an Assistant Professor at Government Engineering College, Rajkot (2011-2015), and VGEC, Chandkheda (2015-present). Ms. Ramavat is proficient in programming languages such as C++ and Java, and has strong skills in cloud computing, teaching, lecturing, management, training, and university teaching. She is fluent in English, Hindi, and Gujarati.",
    block: "D",
    officeImg: "/images/offices/D-302.jpg",
  },
  {
    ...
    bio: "Proff. Nakul Dave is an Assistant Professor with 13 years of experience and a strong background in Computer Science. He earned his B.E. in Computer Engineering from Saurashtra University in 2009 and his M.E. in Computer Science and Engineering from Gujarat Technological University in 2012, both with distinction. His areas of interest include Text Mining and Distributed Systems. Mr. Dave has served as an Assistant Professor at Government Engineering College, Sector-28, Gandhinagar from February to September 2010, and has been with VGEC, Chandkheda since June 2011. He is skilled in teaching subjects like DBMS and Information Security and enjoys playing cricket and volleyball.",
    block: "D",
    officeImg: "/images/offices/D-302.jpg",
  },
  {
    ...
    bio: "Mr. Uttam Chauhan is an Assistant Professor with 13 years of experience in computer engineering, specializing in text summarization and data analytics. He holds a B.E. in Information Technology from Nirma Institute of Technology, Gujarat University (First Class, 2004), an M.E. in Computer Engineering from Dharmsinh Desai University (First Class with Distinction, 2008), and a Ph.D. in Computer Engineering from Gujarat Technological University (2018). He has extensive teaching experience, having worked as a Lecturer at CCET, Wadhwan City (2004-2006), and as an Assistant Professor at Charotar University of Science & Technology (2007-2011) and VGEC (2011-present). Mr. Chauhan is proficient in programming languages such as C, Python, SQL, and PL/SQL, and has strong expertise in text summarization and data analytics.",
    block: "D",
    officeImg: "/images/offices/D-302.jpg",
  },
  {
    ...
    bio: "Mr. Amit Rathod is an Assistant Professor with 8 years of experience, currently pursuing a Ph.D. from Gujarat Technological University. He holds an M.E. in Information Technology from L.D. College of Engineering, Ahmedabad (2013), and a B.E. in Computer Engineering from Nirma Institute of Technology, Ahmedabad (2006). His areas of interest include design thinking, databases, and programming. Mr. Rathod has served as an Assistant Professor in the Information Technology Department at Parul Institute of Engineering & Technology from June 2013 to September 2016. Additionally, he has taught Computer Architecture and Compiler Design, including practical sessions, to PG Diploma students specializing in Cyber Security at Raksha Shakti University.",
    block: "D",
    officeImg: "/images/offices/D-302.jpg",
  },
